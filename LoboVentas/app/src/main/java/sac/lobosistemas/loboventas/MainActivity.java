...
public class MainActivity extends AppCompatActivity {
    ...
    ArrayList<PagoDia> pagoDia = new ArrayList<>(); //Para consultar los pagos diarios
    ArrayList<PagoMes> pagoMes = new ArrayList<>(); //Para consultar los pagos mensuales
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        swipeRefreshLayout.setOnRefreshListener(new SwipeRefreshLayout.OnRefreshListener() {
            ...
            public void onRefresh() {
                ...
                cargarPagoMes();
                txtBuscar.setText("");
                Toast.makeText(MainActivity.this, "La Lista de Empresas y las Barras de Ventas han sido actualizadas.", Toast.LENGTH_SHORT).show();
            }
        });
    ...
    private void clickAdaptador(final ArrayList<Empresa> empresas) {
        ...
        mAdapter.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                intent.putExtra("factura_num",empresas.get(mRecyclerView.getChildAdapterPosition(v)).getFactura_num());
    ...
    public void actualizarBarraMes(){
        ...
        if (pbMes.getProgress() < 40){
            ...
            pbMes.getProgressDrawable().setColorFilter(
                    Color.parseColor("#faa519"), android.graphics.PorterDuff.Mode.SRC_IN);
        }else if (pbMes.getProgress() >= 70){
            pbMes.getProgressDrawable().setColorFilter(
                    Color.parseColor("#73BE46"), android.graphics.PorterDuff.Mode.SRC_IN);
        }
